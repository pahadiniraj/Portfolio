...
const HomeComponent = () => {
  return (
    <div className="flex flex-col md:flex-row  ">
      {/* Image Section */}
      <div className="md:w-2/6 bg-green-200 order-1 md:order-2 p-2  flex flex-col gap-4 justify-center items-center">
      ...
      {/* Text Section */}
      <div className="md:w-3/5 order-2 md:order-1 pl-2 py-2 flex flex-col gap-6 justify-center">
        <section>
